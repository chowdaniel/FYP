...
if __name__ == "__main__":
    ...
    #Find optimal values of entry and stop using trial and error on sample set    
    entry = 0.1
    ...
    #Use the optimal values found to test performance
    sample_returns = a.run_test(max_entry,max_stop)
    validation_returns = b.run_test(max_entry,max_stop)
